...
/*}*/
    ...
    form#asForm input, form#asForm textarea {
    ...
    <div class="row">
        <div class="col-md-12 text-center" style="margin-bottom: 20px;margin-top: 50px">
            <h1>Libro de Reclamaciones Virtual</h1>
                    ...
                    <h3>Hoja de Reclamación N° <?php echo $personas["id"]; ?></h3>
                ...
                <div class="form-group form-libro row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control input-sm" readonly
                               placeholder="" value="<?php echo $personas["respuesta_fecha"]; ?>">
                    </div>
                    <div class="col-sm-12">
                        <textarea readonly class="form-control input-sm" rows="5"
                                  placeholder="" readonly><?php echo $personas["respuesta"]; ?></textarea>
                    </div>
